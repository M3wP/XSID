...
uses
	...
	Vcl.ComCtrls, C64Types;

type
	TReSIDFilterConfigForm = class(TForm)
		Button2: TButton;
		Button1: TButton;
		Button3: TButton;
		TrackBar1: TTrackBar;
...
var
	ReSIDFilterConfigForm: TReSIDFilterConfigForm;

implementation

{$R *.dfm}

procedure TReSIDFilterConfigForm.Button3Click(Sender: TObject);
	begin
	FFilter:= FDefault;
...
procedure TReSIDFilterConfigForm.Edit1KeyPress(Sender: TObject; var Key: Char);
	var
	v: Double;
...
procedure TReSIDFilterConfigForm.FormCreate(Sender: TObject);
	begin
	FFirstTime:= True;
	end;

procedure TReSIDFilterConfigForm.FormShow(Sender: TObject);
	begin
	if  FFirstTime then
		begin
		FDefault:= FFilter;
...
procedure TReSIDFilterConfigForm.TrackBar1Change(Sender: TObject);
	begin
