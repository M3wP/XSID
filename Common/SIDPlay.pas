...
function  DumpSIDCreate(name, fileName: PAnsiChar): Pointer; stdcall; external 'SIDPlay';
procedure DumpSIDDestroy(dumpSID: Pointer); stdcall; external 'SIDPlay';
function  DumpSIDCreateSIDs(dumpSID: Pointer; sids: Cardinal): Cardinal; stdcall; external 'SIDPlay';
function  DumpSIDGetStatus(dumpSID: Pointer): LongBool; stdcall; external 'SIDPlay';
function  DumpSIDGetError(dumpSID: Pointer): PAnsiChar; stdcall; external 'SIDPlay';
//	LIBSIDPLAY_API void * __stdcall DumpSIDGetEmulation(void * dumpSID);


function  SIDTuneCreate(const fileName: PAnsiChar): Pointer; stdcall; external 'SIDPlay';
procedure SIDTuneDestroy(sidtune: Pointer); stdcall; external 'SIDPlay';
function  SIDTuneGetStatus(sidtune: Pointer): LongBool; stdcall; external 'SIDPlay';
function  SIDTuneSelectSong(sidtune: Pointer; songNum: Cardinal): Cardinal; stdcall; external 'SIDPlay';


function  SIDConfigCreate: Pointer; stdcall; external 'SIDPlay';
procedure SIDConfigDestroy(sidconfig: Pointer); stdcall; external 'SIDPlay';
procedure SIDConfigSetFrequency(sidconfig: Pointer; samplerate: Cardinal); stdcall; external 'SIDPlay';
procedure SIDConfigSetSamplingMethod(sidconfig: Pointer; method: Integer); stdcall; external 'SIDPlay';
procedure SIDConfigSetFastSampling(sidconfig: Pointer; fast: LongBool); stdcall; external 'SIDPlay';
procedure SIDConfigSetPlayback(sidconfig: Pointer; playback: Integer); stdcall; external 'SIDPlay';
procedure SIDConfigSetSIDEmulation(sidconfig: Pointer; emulation: Pointer); stdcall; external 'SIDPlay';


function  PlayerCreate: Pointer; stdcall; external 'SIDPlay';
procedure PlayerDestroy(play: Pointer); stdcall; external 'SIDPlay';
procedure PlayerSetROMS(play: Pointer; kernal, basic, character: PByte); stdcall; external 'SIDPlay';
function  PlayerGetInfoMaxSIDs(play: Pointer): Cardinal; stdcall; external 'SIDPlay';
function  PlayerSetConfig(play, sidconfig: Pointer): LongBool; stdcall; external 'SIDPlay';
function  PlayerGetError(play: Pointer): PAnsiChar; stdcall; external 'SIDPlay';
function  PlayerLoadTune(play, sidtune: Pointer): LongBool; stdcall; external 'SIDPlay';
function  PlayerGetCPUFreq(play: Pointer): Double; stdcall; external 'SIDPlay';
function  PlayerGetTime(play: Pointer): Cardinal; stdcall; external 'SIDPlay';
function  PlayerPlay(play: Pointer; buffer: PSmallInt; samples: Cardinal): Cardinal; stdcall; external 'SIDPlay';
{$ENDIF}
